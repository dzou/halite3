...
public class DecisionVector {
  ...
  public DecisionVector(double goHomeScore, double exploreScore, double enemyThreatScore) {
  ...
  public double score() {
    if (enemyThreatScore < 0) {
      ...
      return Math.max(goHomeScore, exploreScore) + 0.10 * enemyThreatScore;
    }
  }
